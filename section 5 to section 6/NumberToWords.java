...
int d=reverse(number);
int digitDiff = getDigitCount(number) - getDigitCount(d);
while (d>0 ){
b=d%10;
if (b==0) System.out.print("Zero ");
if (b==1) System.out.print("One ");
if (b==2) System.out.print("Two ");
if (b==3) System.out.print("Three ");
if (b==4) System.out.print("Four ");
if (b==5) System.out.print("Five ");
if (b==6) System.out.print("Six ");
if (b==7) System.out.print("Seven ");
if (b==8) System.out.print("Eight ");
if (b==9) System.out.print("Nine ");
d=d/10;
}
if (digitDiff>0)
...
public static int getDigitCount(int d){
if (d<0) return -1;
int b=0,count=0;
while (d>=0){
b=d%10;
